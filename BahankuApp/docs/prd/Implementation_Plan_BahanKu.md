  ...
  - Code skeleton:
    ...
    export const useAuth = () => {
      ...
      const register = async (email: string, password: string, name: string) => {
        ...
        if (data.user) {
          await supabase.from('users').insert({ id: data.user.id, email, name, role: 'customer' });
        }
        return data;
      };
...
- [ ] **15. Buat Hook useProducts**
  ...
  - Code skeleton:
    ...
    export const useProducts = () => {
      ...
      return { products, loading, getProducts, getProductById, searchProducts, filterByCategory, createProduct, updateProduct, deleteProduct };
    };
    ```
...
- [ ] **24. Buat Hook useOrders**
  ...
  - Code skeleton:
    ...
    export const useOrders = () => {
      ...
      const createOrder = async (userId: string, items: { product_id: string; quantity: number; subtotal: number }[], totalPrice: number) => {
        setLoading(true);
        // Insert order
      ...
      return { orders, loading, createOrder, getMyOrders, getOrderById, updateOrderStatus };
    };
    ```
...
- [ ] **32. Buat Hook useRecipes**
  ...
  - Code skeleton:
    ...
    export const useRecipes = () => {
      ...
      return { recipes, loading, getRecipes, getRecipeById, toggleFavorite, getMyFavorites };
    };
    ```
